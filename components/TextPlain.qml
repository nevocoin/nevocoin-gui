...
Text {
    ...
    Rectangle {
        ...
        color: root.focus ? NevocoinComponents.Style.titleBarButtonHoverColor : "transparent"
    }
    ...
    NevocoinEffects.ColorTransition {
        ...
        targetObj: root
        duration: 750
        blackColor: root.themeTransitionBlackColor !== "" ? root.themeTransitionBlackColor : NevocoinComponents.Style._b_defaultFontColor
        whiteColor: root.themeTransitionWhiteColor !== "" ? root.themeTransitionWhiteColor : NevocoinComponents.Style._w_defaultFontColor
    }
