...
ColumnLayout {
    ...
    RowLayout {
        ...
        NevocoinComponents.Label {
            color: lineEdit.inputHasFocus ? NevocoinComponents.Style.defaultFontColor : NevocoinComponents.Style.dimmedFontColor
            fontSize: 13
            text: (wordNumber + 1)
        ...
        NevocoinComponents.TextPlain {
            ...
            color: wordsMatch ? (NevocoinComponents.Style.blackTheme ? "#00FF00" : "#008000") : "#FF0000"
            themeTransition: false
            onTextChanged: {
    ...
    Rectangle {
        id: underLine
        color: lineEdit.inputHasFocus ? NevocoinComponents.Style.defaultFontColor : NevocoinComponents.Style.appWindowBorderColor
